...
@Repository
public class MuseumRepositoryBean implements MuseumRepository {
	private final JpaMuseumRepository jpaProductRepository;
	
	public MuseumRepositoryBean(JpaMuseumRepository jpaProductRepository) {
		this.jpaProductRepository = jpaProductRepository;
	}
	
	@Override
	public List<Museum> saveAll(Iterable<Museum> entities) {
