...
@Repository
public class ChapterRepositoryBean implements ChapterRepository {
	private final JpaChapterRepository jpaChapterRepository;
	
	public ChapterRepositoryBean(JpaChapterRepository jpaChapterRepository) {
		this.jpaChapterRepository = jpaChapterRepository;
	}
