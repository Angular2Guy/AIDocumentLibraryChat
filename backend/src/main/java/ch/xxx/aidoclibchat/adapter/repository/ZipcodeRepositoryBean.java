...
@Repository
public class ZipcodeRepositoryBean implements ZipcodeRepository {
	private final JpaZipcodeRepository jpaZipcodeRepository;
	
	public ZipcodeRepositoryBean(JpaZipcodeRepository jpaZipcodeRepository) {
		this.jpaZipcodeRepository = jpaZipcodeRepository;
	}
	
	@Override
	public List<Zipcode> saveAll(Iterable<Zipcode> entities) {
